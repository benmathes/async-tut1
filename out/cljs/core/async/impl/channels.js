...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14932 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14932 = (function (val,box,meta14933){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14932.cljs$lang$type = true;
cljs.core.async.impl.channels.t14932.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14932";
cljs.core.async.impl.channels.t14932.cljs$lang$ctorPrWriter = (function (this__3670__auto__,writer__3671__auto__,opt__3672__auto__){return cljs.core._write.call(null,writer__3671__auto__,"cljs.core.async.impl.channels/t14932");
});
cljs.core.async.impl.channels.t14932.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14932.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14934){var self__ = this;
var _14934__$1 = this;return self__.meta14933;
});
cljs.core.async.impl.channels.t14932.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14934,meta14933__$1){var self__ = this;
var _14934__$1 = this;return (new cljs.core.async.impl.channels.t14932(self__.val,self__.box,meta14933__$1));
});
cljs.core.async.impl.channels.__GT_t14932 = (function __GT_t14932(val__$1,box__$1,meta14933){return (new cljs.core.async.impl.channels.t14932(val__$1,box__$1,meta14933));
});
}
return (new cljs.core.async.impl.channels.t14932(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3673__auto__,writer__3674__auto__,opts__3675__auto__){return cljs.core._write.call(null,writer__3674__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3670__auto__,writer__3671__auto__,opt__3672__auto__){return cljs.core._write.call(null,writer__3671__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14935 = self__.takes.pop();if((taker_14935 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14935))
{var take_cb_14936 = cljs.core.async.impl.protocols.commit.call(null,taker_14935);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14936,taker_14935){
return (function (){return take_cb_14936.call(null,null);
});})(take_cb_14936,taker_14935))
);
} else
{}
{
...
{var take_cb = cljs.core.async.impl.protocols.commit.call(null,taker);var _ = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb,_,taker){
