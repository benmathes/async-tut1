...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14926 = 0;while(true){
var m_14927 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14927 == null))
{} else
{m_14927.call(null);
if((count_14926 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14928 = (count_14926 + 1);
count_14926 = G__14928;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3124__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3124__auto__)
