...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3670__auto__,writer__3671__auto__,opt__3672__auto__){return cljs.core._write.call(null,writer__3671__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14903 = 0;while(true){
if((i_14903 < arr.length))
{(arr[i_14903] = null);
{
var G__14904 = (i_14903 + 1);
i_14903 = G__14904;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3670__auto__,writer__3671__auto__,opt__3672__auto__){return cljs.core._write.call(null,writer__3671__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14910 = (self__.level + 1);while(true){
if((i_14910 <= (new_level + 1)))
{(update[i_14910] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14912 = 0;while(true){
if((i_14912 <= self__.level))
{var links_14913 = (update[i_14912]).forward;if(((links_14913[i_14912]) === x__$1))
{(links_14913[i_14912] = (x__$1.forward[i_14912]));
{
var G__14914 = (i_14912 + 1);
i_14912 = G__14914;
continue;
}
} else
{{
var G__14915 = (i_14912 + 1);
i_14912 = G__14915;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3133__auto__ = (cljs.core.truth_((function (){var and__3124__auto__ = me;if(cljs.core.truth_(and__3124__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3124__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3133__auto__))
